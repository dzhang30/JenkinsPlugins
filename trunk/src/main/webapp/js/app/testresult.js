...
function populateTemplate(){
	...
	var teststatus = $j('#teststatus').val();
	var selectBuild = $j('#selectBuild').val();
	displayValues  = $j("#show-durations").is(":checked");
	//add buttons here
	remoteAction.getTreeResult(noOfBuilds,selectBuild,teststatus,displayValues,$j.proxy(function(t) {
